...
::: {layout-ncol=2}
![Default Template Page 1](assets/images/quiz_set_1_page-1.png){width=400}

![Default Template Page 2](assets/images/quiz_set_1_page-2.png){width=400}
:::

[Download PDF - Default Template](assets/quiz_set_1.pdf){.btn .btn-primary}
...
::: {layout-ncol=2}
![Compact Template Preview](assets/images/compact_preview.png){width=400}

![Compact Template Preview 2](assets/images/compact_preview2.png){width=400}
:::
...
::: {layout-ncol=2}
![Academic Template Preview](assets/images/academic_preview.png){width=400}

![Academic Template Preview 2](assets/images/academic_preview2.png){width=400}
:::

[Download PDF - Academic Template](assets/academic_sample.pdf){.btn .btn-primary}
...
::: {layout-ncol=2}
![Minimal Template Preview](assets/images/minimal_preview.png){width=400}

![Minimal Template Preview 2](assets/images/minimal_preview2.png){width=400}
:::
